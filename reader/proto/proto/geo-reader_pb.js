 ...
 * @const
 */
proto.pb.CheckChangesTreeGeoResponse.repeatedFields_ = [4];
...
proto.pb.CheckChangesTreeGeoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    status: jspb.Message.getBooleanFieldWithDefault(msg, 1, false),
    firstload: jspb.Message.getBooleanFieldWithDefault(msg, 2, false),
...
/**
 * repeated ChangeFile changeFiles = 4;
...
proto.pb.CheckChangesTreeGeoResponse.prototype.getChangefilesList = function() {
  return /** @type{!Array<!proto.pb.ChangeFile>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pb.ChangeFile, 4));
};
...
proto.pb.CheckChangesTreeGeoResponse.prototype.addChangefiles = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.pb.ChangeFile, opt_index);
};
