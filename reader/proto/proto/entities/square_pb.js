// source: proto/entities/square.proto
/**
 * @fileoverview
 * @enhanceable
...
proto.pb.Square.prototype.getGeofenceList = function() {
  return /** @type{!Array<!proto.pb.Geofence>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto_entities_geofence_pb.Geofence, 6));
};
...
proto.pb.Square.prototype.getRoadList = function() {
  return /** @type{!Array<!proto.pb.Road>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto_entities_road_pb.Road, 7));
};
...
proto.pb.Square.prototype.getPitList = function() {
  return /** @type{!Array<!proto.pb.Pit>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto_entities_pit_pb.Pit, 8));
};
...
proto.pb.Square.prototype.getPadList = function() {
  return /** @type{!Array<!proto.pb.Pad>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto_entities_pad_pb.Pad, 9));
};
...
proto.pb.Square.prototype.getDmeList = function() {
  return /** @type{!Array<!proto.pb.Dme>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto_entities_dme_pb.Dme, 11));
};
