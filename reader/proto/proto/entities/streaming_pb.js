...
goog.exportSymbol('proto.pb.Socket', null, global);
goog.exportSymbol('proto.pb.Socket.SocketOfCase', null, global);
 ...
 * @constructor
 */
proto.pb.Socket = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.pb.Socket.oneofGroups_);
};
goog.inherits(proto.pb.Socket, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.Socket.displayName = 'proto.pb.Socket';
}
 ...
 * @const
 */
proto.pb.Socket.oneofGroups_ = [[1,2,3]];

/**
 * @enum {number}
 */
proto.pb.Socket.SocketOfCase = {
  SOCKET_OF_NOT_SET: 0,
  BASIC_SENSOR: 1,
  TRUCK_INFO: 2,
  EXCAVATOR_INFO: 3
...
/**
 * @return {proto.pb.Socket.SocketOfCase}
 */
proto.pb.Socket.prototype.getSocketOfCase = function() {
  return /** @type {proto.pb.Socket.SocketOfCase} */(jspb.Message.computeOneofCase(this, proto.pb.Socket.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.pb.Socket.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.Socket.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.Socket} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.Socket.toObject = function(includeInstance, msg) {
  var f, obj = {
    basicSensor: (f = msg.getBasicSensor()) && proto_entities_sensor_pb.BasicSensor.toObject(includeInstance, f),
    truckInfo: (f = msg.getTruckInfo()) && proto.pb.TruckInfo.toObject(includeInstance, f),
    excavatorInfo: (f = msg.getExcavatorInfo()) && proto.pb.ExcavatorInfo.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.Socket}
 */
proto.pb.Socket.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.Socket;
  return proto.pb.Socket.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.Socket} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.Socket}
 */
proto.pb.Socket.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pb.Socket.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.Socket.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.Socket} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.Socket.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBasicSensor();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
...
/**
 * optional BasicSensor basic_sensor = 1;
 * @return {?proto.pb.BasicSensor}
 */
proto.pb.Socket.prototype.getBasicSensor = function() {
 ...
 * @return {!proto.pb.Socket} returns this
*/
proto.pb.Socket.prototype.setBasicSensor = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.pb.Socket.oneofGroups_[0], value);
};
 ...
 * @return {!proto.pb.Socket} returns this
 */
proto.pb.Socket.prototype.clearBasicSensor = function() {
  return this.setBasicSensor(undefined);
};
 ...
 * @return {boolean}
 */
proto.pb.Socket.prototype.hasBasicSensor = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional TruckInfo truck_info = 2;
 * @return {?proto.pb.TruckInfo}
 */
proto.pb.Socket.prototype.getTruckInfo = function() {
  return /** @type{?proto.pb.TruckInfo} */ (
    jspb.Message.getWrapperField(this, proto.pb.TruckInfo, 2));
};
 ...
 * @return {!proto.pb.Socket} returns this
*/
proto.pb.Socket.prototype.setTruckInfo = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.pb.Socket.oneofGroups_[0], value);
};
 ...
 * @return {!proto.pb.Socket} returns this
 */
proto.pb.Socket.prototype.clearTruckInfo = function() {
  return this.setTruckInfo(undefined);
};
 ...
 * @return {boolean}
 */
proto.pb.Socket.prototype.hasTruckInfo = function() {
  return jspb.Message.getField(this, 2) != null;
};


/**
 * optional ExcavatorInfo excavator_info = 3;
 * @return {?proto.pb.ExcavatorInfo}
 */
proto.pb.Socket.prototype.getExcavatorInfo = function() {
  return /** @type{?proto.pb.ExcavatorInfo} */ (
    jspb.Message.getWrapperField(this, proto.pb.ExcavatorInfo, 3));
};
 ...
 * @return {!proto.pb.Socket} returns this
*/
proto.pb.Socket.prototype.setExcavatorInfo = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.pb.Socket.oneofGroups_[0], value);
};
 ...
 * @return {!proto.pb.Socket} returns this
 */
proto.pb.Socket.prototype.clearExcavatorInfo = function() {
  return this.setExcavatorInfo(undefined);
};
 ...
 * @return {boolean}
 */
proto.pb.Socket.prototype.hasExcavatorInfo = function() {
