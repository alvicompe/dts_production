...
var proto_services_polygon_services_pb = require('../../proto/services/polygon.services_pb.js');
var proto_entities_polygon_pb = require('../../proto/entities/polygon_pb.js');

function serialize_pb_PolygonListRequest(arg) {
  if (!(arg instanceof proto_services_polygon_services_pb.PolygonListRequest)) {
...
function deserialize_pb_PolygonListRequest(buffer_arg) {
  return proto_services_polygon_services_pb.PolygonListRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_PolygonListResponse(arg) {
  if (!(arg instanceof proto_services_polygon_services_pb.PolygonListResponse)) {
...
function deserialize_pb_PolygonListResponse(buffer_arg) {
  return proto_services_polygon_services_pb.PolygonListResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_PolygonRequest(arg) {
  if (!(arg instanceof proto_services_polygon_services_pb.PolygonRequest)) {
...
function deserialize_pb_PolygonRequest(buffer_arg) {
  return proto_services_polygon_services_pb.PolygonRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_PolygonResponse(arg) {
  if (!(arg instanceof proto_services_polygon_services_pb.PolygonResponse)) {
...
function deserialize_pb_PolygonResponse(buffer_arg) {
  return proto_services_polygon_services_pb.PolygonResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_PolygonsResponse(arg) {
  if (!(arg instanceof proto_services_polygon_services_pb.PolygonsResponse)) {
...
function deserialize_pb_PolygonsResponse(buffer_arg) {
  return proto_services_polygon_services_pb.PolygonsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_RetrievePolygonByProjectNameRequest(arg) {
  if (!(arg instanceof proto_services_polygon_services_pb.RetrievePolygonByProjectNameRequest)) {
...
function deserialize_pb_RetrievePolygonByProjectNameRequest(buffer_arg) {
  return proto_services_polygon_services_pb.RetrievePolygonByProjectNameRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var PolygonServiceService = exports.PolygonServiceService = {
  createPolygon: {
    ...
    requestType: proto_services_polygon_services_pb.PolygonRequest,
    responseType: proto_services_polygon_services_pb.PolygonResponse,
  ...
  retrievePolygons: {
    ...
    responseStream: false,
    requestType: proto_services_polygon_services_pb.PolygonRequest,
    responseType: proto_services_polygon_services_pb.PolygonsResponse,
    requestSerialize: serialize_pb_PolygonRequest,
    requestDeserialize: deserialize_pb_PolygonRequest,
  ...
  retrievePolygonByProjectName: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: proto_services_polygon_services_pb.RetrievePolygonByProjectNameRequest,
    responseType: proto_services_polygon_services_pb.PolygonResponse,
  ...
  finalizePolygonList: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: proto_services_polygon_services_pb.PolygonListRequest,
    responseType: proto_services_polygon_services_pb.PolygonListResponse,
