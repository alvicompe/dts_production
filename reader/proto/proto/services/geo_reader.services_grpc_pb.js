...
var proto_services_geo_reader_services_pb = require('../../proto/services/geo_reader.services_pb.js');
...
function serialize_pb_AutomaticallyExecuteChangeTreeGeoResponse(arg) {
  if (!(arg instanceof proto_services_geo_reader_services_pb.AutomaticallyExecuteChangeTreeGeoResponse)) {
...
function deserialize_pb_AutomaticallyExecuteChangeTreeGeoResponse(buffer_arg) {
  return proto_services_geo_reader_services_pb.AutomaticallyExecuteChangeTreeGeoResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_ChangesGeoNotificationResponse(arg) {
  if (!(arg instanceof proto_services_geo_reader_services_pb.ChangesGeoNotificationResponse)) {
...
function deserialize_pb_ChangesGeoNotificationResponse(buffer_arg) {
  return proto_services_geo_reader_services_pb.ChangesGeoNotificationResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_CreateTreeGeoResponse(arg) {
  if (!(arg instanceof proto_services_geo_reader_services_pb.CreateTreeGeoResponse)) {
...
function deserialize_pb_CreateTreeGeoResponse(buffer_arg) {
  return proto_services_geo_reader_services_pb.CreateTreeGeoResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_GeoTreeResponse(arg) {
  if (!(arg instanceof proto_services_geo_reader_services_pb.GeoTreeResponse)) {
...
function deserialize_pb_GeoTreeResponse(buffer_arg) {
  return proto_services_geo_reader_services_pb.GeoTreeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var GeoReaderServiceService = exports.GeoReaderServiceService = {
  retrieveTreeGeo: {
    ...
    responseType: proto_services_geo_reader_services_pb.GeoTreeResponse,
  ...
  createTreeGeo: {
    ...
    responseStream: false,
    requestType: google_protobuf_empty_pb.Empty,
    responseType: proto_services_geo_reader_services_pb.CreateTreeGeoResponse,
    requestSerialize: serialize_google_protobuf_Empty,
    requestDeserialize: deserialize_google_protobuf_Empty,
  ...
  checkChangesTreeGeo: {
    ...
    responseStream: true,
    requestType: google_protobuf_empty_pb.Empty,
    responseType: proto_services_geo_reader_services_pb.ChangesGeoNotificationResponse,
    requestSerialize: serialize_google_protobuf_Empty,
    requestDeserialize: deserialize_google_protobuf_Empty,
  ...
  automaticallyExecuteChangeTreeGeo: {
    ...
    responseStream: false,
    requestType: google_protobuf_empty_pb.Empty,
    responseType: proto_services_geo_reader_services_pb.AutomaticallyExecuteChangeTreeGeoResponse,
    requestSerialize: serialize_google_protobuf_Empty,
    requestDeserialize: deserialize_google_protobuf_Empty,
