...
var proto_services_contractor_services_pb = require('../../proto/services/contractor.services_pb.js');
var proto_entities_contractor_pb = require('../../proto/entities/contractor_pb.js');

function serialize_pb_ContractorRequest(arg) {
  if (!(arg instanceof proto_services_contractor_services_pb.ContractorRequest)) {
...
function deserialize_pb_ContractorRequest(buffer_arg) {
  return proto_services_contractor_services_pb.ContractorRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_ContractorResponse(arg) {
  if (!(arg instanceof proto_services_contractor_services_pb.ContractorResponse)) {
...
function deserialize_pb_ContractorResponse(buffer_arg) {
  return proto_services_contractor_services_pb.ContractorResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_ContractorsResponse(arg) {
  if (!(arg instanceof proto_services_contractor_services_pb.ContractorsResponse)) {
...
function deserialize_pb_ContractorsResponse(buffer_arg) {
  return proto_services_contractor_services_pb.ContractorsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ContractorServiceService = exports.ContractorServiceService = {
  createContractor: {
    ...
    requestType: proto_services_contractor_services_pb.ContractorRequest,
    responseType: proto_services_contractor_services_pb.ContractorResponse,
  ...
  retrieveContractors: {
    ...
    responseStream: false,
    requestType: proto_services_contractor_services_pb.ContractorRequest,
    responseType: proto_services_contractor_services_pb.ContractorsResponse,
    requestSerialize: serialize_pb_ContractorRequest,
    requestDeserialize: deserialize_pb_ContractorRequest,
