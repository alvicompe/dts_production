...
var proto_services_geo_services_pb = require('../../proto/services/geo.services_pb.js');
var proto_entities_geo_pb = require('../../proto/entities/geo_pb.js');

function serialize_pb_GeoChunkRequest(arg) {
  if (!(arg instanceof proto_services_geo_services_pb.GeoChunkRequest)) {
...
function deserialize_pb_GeoChunkRequest(buffer_arg) {
  return proto_services_geo_services_pb.GeoChunkRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_GeoChunkResponse(arg) {
  if (!(arg instanceof proto_services_geo_services_pb.GeoChunkResponse)) {
...
function deserialize_pb_GeoChunkResponse(buffer_arg) {
  return proto_services_geo_services_pb.GeoChunkResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_GeoEmptyRequest(arg) {
  if (!(arg instanceof proto_services_geo_services_pb.GeoEmptyRequest)) {
...
function deserialize_pb_GeoEmptyRequest(buffer_arg) {
  return proto_services_geo_services_pb.GeoEmptyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_GeoRequest(arg) {
  if (!(arg instanceof proto_services_geo_services_pb.GeoRequest)) {
...
function deserialize_pb_GeoRequest(buffer_arg) {
  return proto_services_geo_services_pb.GeoRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_GeoResponse(arg) {
  if (!(arg instanceof proto_services_geo_services_pb.GeoResponse)) {
...
function deserialize_pb_GeoResponse(buffer_arg) {
  return proto_services_geo_services_pb.GeoResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_GeosResponse(arg) {
  if (!(arg instanceof proto_services_geo_services_pb.GeosResponse)) {
...
function deserialize_pb_GeosResponse(buffer_arg) {
  return proto_services_geo_services_pb.GeosResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var GeoServiceService = exports.GeoServiceService = {
  uploadGeo: {
    ...
    requestType: proto_services_geo_services_pb.GeoChunkRequest,
    responseType: proto_services_geo_services_pb.GeoChunkResponse,
  ...
  createGeo: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: proto_services_geo_services_pb.GeoRequest,
    responseType: proto_services_geo_services_pb.GeoResponse,
  ...
  retrieveGeos: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: proto_services_geo_services_pb.GeoEmptyRequest,
    responseType: proto_services_geo_services_pb.GeosResponse,
