...
interface IReportTimelineServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
    ...
    timelineByShift: IReportTimelineServiceService_ITimelineByShift;
}
...
interface IReportTimelineServiceService_ITimelineByShift extends grpc.MethodDefinition<proto_services_report_timeline_services_pb.DownloadTimelineRequest, proto_services_report_services_pb.DownloadResponse> {
    path: string; // "/pb.ReportTimelineService/TimelineByShift"
    requestStream: false;
    responseStream: false;
...
export interface IReportTimelineServiceServer {
    ...
    timelineByShift: grpc.handleUnaryCall<proto_services_report_timeline_services_pb.DownloadTimelineRequest, proto_services_report_services_pb.DownloadResponse>;
}
...
export interface IReportTimelineServiceClient {
    ...
    timelineByShift(request: proto_services_report_timeline_services_pb.DownloadTimelineRequest, callback: (error: grpc.ServiceError | null, response: proto_services_report_services_pb.DownloadResponse) => void): grpc.ClientUnaryCall;
    timelineByShift(request: proto_services_report_timeline_services_pb.DownloadTimelineRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: proto_services_report_services_pb.DownloadResponse) => void): grpc.ClientUnaryCall;
    timelineByShift(request: proto_services_report_timeline_services_pb.DownloadTimelineRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: proto_services_report_services_pb.DownloadResponse) => void): grpc.ClientUnaryCall;
}
...
export class ReportTimelineServiceClient extends grpc.Client implements IReportTimelineServiceClient {
    ...
    public timelineByShift(request: proto_services_report_timeline_services_pb.DownloadTimelineRequest, callback: (error: grpc.ServiceError | null, response: proto_services_report_services_pb.DownloadResponse) => void): grpc.ClientUnaryCall;
    public timelineByShift(request: proto_services_report_timeline_services_pb.DownloadTimelineRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: proto_services_report_services_pb.DownloadResponse) => void): grpc.ClientUnaryCall;
    public timelineByShift(request: proto_services_report_timeline_services_pb.DownloadTimelineRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: proto_services_report_services_pb.DownloadResponse) => void): grpc.ClientUnaryCall;
}
