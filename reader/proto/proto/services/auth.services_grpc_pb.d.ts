...
interface IAuthServiceService_IRefreshToken extends grpc.MethodDefinition<proto_services_auth_services_pb.LoginRequest, proto_services_auth_services_pb.LoginResponse> {
    path: string; // "/pb.AuthService/RefreshToken"
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<proto_services_auth_services_pb.LoginRequest>;
    requestDeserialize: grpc.deserialize<proto_services_auth_services_pb.LoginRequest>;
...
export interface IAuthServiceServer {
    ...
    refreshToken: grpc.handleUnaryCall<proto_services_auth_services_pb.LoginRequest, proto_services_auth_services_pb.LoginResponse>;
}
...
export interface IAuthServiceClient {
    ...
    refreshToken(request: proto_services_auth_services_pb.LoginRequest, callback: (error: grpc.ServiceError | null, response: proto_services_auth_services_pb.LoginResponse) => void): grpc.ClientUnaryCall;
    refreshToken(request: proto_services_auth_services_pb.LoginRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: proto_services_auth_services_pb.LoginResponse) => void): grpc.ClientUnaryCall;
    refreshToken(request: proto_services_auth_services_pb.LoginRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: proto_services_auth_services_pb.LoginResponse) => void): grpc.ClientUnaryCall;
}
...
export class AuthServiceClient extends grpc.Client implements IAuthServiceClient {
    ...
    public refreshToken(request: proto_services_auth_services_pb.LoginRequest, callback: (error: grpc.ServiceError | null, response: proto_services_auth_services_pb.LoginResponse) => void): grpc.ClientUnaryCall;
    public refreshToken(request: proto_services_auth_services_pb.LoginRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: proto_services_auth_services_pb.LoginResponse) => void): grpc.ClientUnaryCall;
    public refreshToken(request: proto_services_auth_services_pb.LoginRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: proto_services_auth_services_pb.LoginResponse) => void): grpc.ClientUnaryCall;
}
