...
goog.object.extend(proto, proto_entities_history_timeline_pb);
goog.exportSymbol('proto.pb.FilterHistoryTimelineRequest', null, global);
goog.exportSymbol('proto.pb.ListHistoryTimelineResponse', null, global);
/**
 ...
 * @constructor
 */
proto.pb.ListHistoryTimelineResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.pb.ListHistoryTimelineResponse.repeatedFields_, null);
};
goog.inherits(proto.pb.ListHistoryTimelineResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pb.ListHistoryTimelineResponse.displayName = 'proto.pb.ListHistoryTimelineResponse';
}
 ...
 * @const
 */
proto.pb.ListHistoryTimelineResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.pb.ListHistoryTimelineResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.pb.ListHistoryTimelineResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pb.ListHistoryTimelineResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ListHistoryTimelineResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    historyTimelinesList: jspb.Message.toObjectList(msg.getHistoryTimelinesList(),
    proto_entities_history_timeline_pb.HistoryTimeline.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pb.ListHistoryTimelineResponse}
 */
proto.pb.ListHistoryTimelineResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pb.ListHistoryTimelineResponse;
  return proto.pb.ListHistoryTimelineResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pb.ListHistoryTimelineResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pb.ListHistoryTimelineResponse}
 */
proto.pb.ListHistoryTimelineResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto_entities_history_timeline_pb.HistoryTimeline;
      reader.readMessage(value,proto_entities_history_timeline_pb.HistoryTimeline.deserializeBinaryFromReader);
      msg.addHistoryTimelines(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.pb.ListHistoryTimelineResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pb.ListHistoryTimelineResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pb.ListHistoryTimelineResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pb.ListHistoryTimelineResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getHistoryTimelinesList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto_entities_history_timeline_pb.HistoryTimeline.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated HistoryTimeline history_timelines = 1;
 * @return {!Array<!proto.pb.HistoryTimeline>}
 */
proto.pb.ListHistoryTimelineResponse.prototype.getHistoryTimelinesList = function() {
  return /** @type{!Array<!proto.pb.HistoryTimeline>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto_entities_history_timeline_pb.HistoryTimeline, 1));
};


/**
 * @param {!Array<!proto.pb.HistoryTimeline>} value
 * @return {!proto.pb.ListHistoryTimelineResponse} returns this
*/
proto.pb.ListHistoryTimelineResponse.prototype.setHistoryTimelinesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.pb.HistoryTimeline=} opt_value
 * @param {number=} opt_index
 * @return {!proto.pb.HistoryTimeline}
 */
proto.pb.ListHistoryTimelineResponse.prototype.addHistoryTimelines = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.pb.HistoryTimeline, opt_index);
};
 ...
 * @return {!proto.pb.ListHistoryTimelineResponse} returns this
 */
proto.pb.ListHistoryTimelineResponse.prototype.clearHistoryTimelinesList = function() {
  return this.setHistoryTimelinesList([]);
};
