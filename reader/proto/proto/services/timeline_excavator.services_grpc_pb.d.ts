...
interface ITimelineExcavatorServiceService extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
    ...
    updateTimelineExcavatorListBeforeShiftChange: ITimelineExcavatorServiceService_IUpdateTimelineExcavatorListBeforeShiftChange;
...
interface ITimelineExcavatorServiceService_IUpdateTimelineExcavatorBeforeShiftChange extends grpc.MethodDefinition<proto_services_timeline_truck_services_pb.UnitCurrentTimelineRequest, proto_services_timeline_truck_services_pb.UnitCurrentTimelineResponse> {
...
interface ITimelineExcavatorServiceService_IUpdateTimelineExcavatorListBeforeShiftChange extends grpc.MethodDefinition<proto_services_timeline_truck_services_pb.TimelineFinalizeShiftRequest, proto_services_timeline_truck_services_pb.TimelineListResponse> {
    path: string; // "/pb.TimelineExcavatorService/UpdateTimelineExcavatorListBeforeShiftChange"
    requestStream: false;
    responseStream: false;
...
export interface ITimelineExcavatorServiceServer {
    ...
    updateTimelineExcavatorBeforeShiftChange: grpc.handleUnaryCall<proto_services_timeline_truck_services_pb.UnitCurrentTimelineRequest, proto_services_timeline_truck_services_pb.UnitCurrentTimelineResponse>;
    updateTimelineExcavatorListBeforeShiftChange: grpc.handleUnaryCall<proto_services_timeline_truck_services_pb.TimelineFinalizeShiftRequest, proto_services_timeline_truck_services_pb.TimelineListResponse>;
...
export interface ITimelineExcavatorServiceClient {
    ...
    updateTimelineExcavatorBeforeShiftChange(request: proto_services_timeline_truck_services_pb.UnitCurrentTimelineRequest, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.UnitCurrentTimelineResponse) => void): grpc.ClientUnaryCall;
    updateTimelineExcavatorBeforeShiftChange(request: proto_services_timeline_truck_services_pb.UnitCurrentTimelineRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.UnitCurrentTimelineResponse) => void): grpc.ClientUnaryCall;
    ...
    updateTimelineExcavatorListBeforeShiftChange(request: proto_services_timeline_truck_services_pb.TimelineFinalizeShiftRequest, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.TimelineListResponse) => void): grpc.ClientUnaryCall;
    updateTimelineExcavatorListBeforeShiftChange(request: proto_services_timeline_truck_services_pb.TimelineFinalizeShiftRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.TimelineListResponse) => void): grpc.ClientUnaryCall;
    updateTimelineExcavatorListBeforeShiftChange(request: proto_services_timeline_truck_services_pb.TimelineFinalizeShiftRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.TimelineListResponse) => void): grpc.ClientUnaryCall;
...
export class TimelineExcavatorServiceClient extends grpc.Client implements ITimelineExcavatorServiceClient {
    ...
    public updateTimelineExcavatorBeforeShiftChange(request: proto_services_timeline_truck_services_pb.UnitCurrentTimelineRequest, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.UnitCurrentTimelineResponse) => void): grpc.ClientUnaryCall;
    public updateTimelineExcavatorBeforeShiftChange(request: proto_services_timeline_truck_services_pb.UnitCurrentTimelineRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.UnitCurrentTimelineResponse) => void): grpc.ClientUnaryCall;
    public updateTimelineExcavatorBeforeShiftChange(request: proto_services_timeline_truck_services_pb.UnitCurrentTimelineRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.UnitCurrentTimelineResponse) => void): grpc.ClientUnaryCall;
    public updateTimelineExcavatorListBeforeShiftChange(request: proto_services_timeline_truck_services_pb.TimelineFinalizeShiftRequest, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.TimelineListResponse) => void): grpc.ClientUnaryCall;
    public updateTimelineExcavatorListBeforeShiftChange(request: proto_services_timeline_truck_services_pb.TimelineFinalizeShiftRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.TimelineListResponse) => void): grpc.ClientUnaryCall;
    public updateTimelineExcavatorListBeforeShiftChange(request: proto_services_timeline_truck_services_pb.TimelineFinalizeShiftRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: proto_services_timeline_truck_services_pb.TimelineListResponse) => void): grpc.ClientUnaryCall;
