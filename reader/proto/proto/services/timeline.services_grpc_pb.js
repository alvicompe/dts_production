...
function deserialize_pb_CurrentTimelineByTruckRequest(buffer_arg) {
  return proto_services_timeline_services_pb.CurrentTimelineByTruckRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_TimelineFinalizeShiftRequest(arg) {
  if (!(arg instanceof proto_services_timeline_services_pb.TimelineFinalizeShiftRequest)) {
...
function deserialize_pb_TimelineFinalizeShiftRequest(buffer_arg) {
  return proto_services_timeline_services_pb.TimelineFinalizeShiftRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_TimelineListRequest(arg) {
  if (!(arg instanceof proto_services_timeline_services_pb.TimelineListRequest)) {
...
function deserialize_pb_TimelineListRequest(buffer_arg) {
  return proto_services_timeline_services_pb.TimelineListRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_TimelineListResponse(arg) {
  if (!(arg instanceof proto_services_timeline_services_pb.TimelineListResponse)) {
...
function deserialize_pb_TimelineListResponse(buffer_arg) {
  return proto_services_timeline_services_pb.TimelineListResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_TimelineRequest(arg) {
  if (!(arg instanceof proto_services_timeline_services_pb.TimelineRequest)) {
...
function deserialize_pb_TimelineRequest(buffer_arg) {
  return proto_services_timeline_services_pb.TimelineRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_TimelineResponse(arg) {
  if (!(arg instanceof proto_services_timeline_services_pb.TimelineResponse)) {
...
function deserialize_pb_TimelineResponse(buffer_arg) {
  return proto_services_timeline_services_pb.TimelineResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_TimelinesShiftRequest(arg) {
  if (!(arg instanceof proto_services_timeline_services_pb.TimelinesShiftRequest)) {
...
function deserialize_pb_TimelinesShiftRequest(buffer_arg) {
  return proto_services_timeline_services_pb.TimelinesShiftRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_pb_UnitCurrentTimelineRequest(arg) {
  if (!(arg instanceof proto_services_timeline_services_pb.UnitCurrentTimelineRequest)) {
...
function deserialize_pb_UnitCurrentTimelineRequest(buffer_arg) {
  return proto_services_timeline_services_pb.UnitCurrentTimelineRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pb_UnitCurrentTimelineResponse(arg) {
  if (!(arg instanceof proto_services_timeline_services_pb.UnitCurrentTimelineResponse)) {
...
function deserialize_pb_UnitCurrentTimelineResponse(buffer_arg) {
  return proto_services_timeline_services_pb.UnitCurrentTimelineResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var TimelineServiceService = exports.TimelineServiceService = {
  retrieveTimeline: {
    ...
    requestType: proto_services_timeline_services_pb.TimelineRequest,
    responseType: proto_services_timeline_services_pb.TimelineResponse,
  ...
  retrieveCurrentTimelineByTruck: {
    path: '/pb.TimelineService/RetrieveCurrentTimelineByTruck',
    requestStream: false,
    responseStream: false,
    requestType: proto_services_timeline_services_pb.CurrentTimelineByTruckRequest,
    responseType: proto_services_timeline_services_pb.TimelineResponse,
  ...
  updateInitialHourmeterTimeline: {
    ...
    responseStream: false,
    requestType: proto_services_timeline_services_pb.TimelineRequest,
    responseType: proto_services_timeline_services_pb.UnitCurrentTimelineResponse,
    requestSerialize: serialize_pb_TimelineRequest,
    requestDeserialize: deserialize_pb_TimelineRequest,
    responseSerialize: serialize_pb_UnitCurrentTimelineResponse,
    responseDeserialize: deserialize_pb_UnitCurrentTimelineResponse,
  },
  updateTimelineBeforeShiftChange: {
    path: '/pb.TimelineService/UpdateTimelineBeforeShiftChange',
    requestStream: false,
    responseStream: false,
    requestType: proto_services_timeline_services_pb.UnitCurrentTimelineRequest,
    responseType: proto_services_timeline_services_pb.UnitCurrentTimelineResponse,
  ...
  updateTimelineList: {
    path: '/pb.TimelineService/UpdateTimelineList',
    requestStream: false,
    responseStream: false,
    requestType: proto_services_timeline_services_pb.TimelineListRequest,
    responseType: proto_services_timeline_services_pb.TimelineListResponse,
  ...
  finalizeShift: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: proto_services_timeline_services_pb.TimelineFinalizeShiftRequest,
    responseType: proto_services_timeline_services_pb.TimelineListResponse,
