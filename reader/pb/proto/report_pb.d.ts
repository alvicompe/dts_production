...
export class DownloadRequest extends jspb.Message {
  ...
  clearTruckList(): DownloadRequest;
...
export class ReportResponse extends jspb.Message {
  ...
  clearTruckCycleList(): ReportResponse;
  ...
  clearExcavatorCycleList(): ReportResponse;
